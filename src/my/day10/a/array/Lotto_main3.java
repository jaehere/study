...
public class Lotto_main3 {
	...
	public static void main(String[] args) {
		// 1부터 45까지의 숫자중 랜덤하게 6개의 숫자를 추출하도록 한다.
		// 101부터 145까지의 숫자중 랜덤하게 6개의 숫자를 추출하도록 한다.
		/*
 			int ball ==>   1    2    3 ...   45
		...
		*/
		...
		for(int i=0; i<6; i++) {
			...
			for(int j=0;j<tempArr.length;j++) {
				if(idx == tempArr[j]) { //중복방지
					// 새로이 뽑아온 방번호(idx)가 기존에 뽑은것(tempArr[j])과 같다라면 다시 새로이 뽑아야한다.
					i--;
					continue outer;
				}

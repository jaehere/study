...
public class Calendar_main {
	...
	public static void main(String[] args) {
	      ...
	      // ▷  현재시각 1 => Mon Dec 20 15:03:58 KST 2021
	      
	      System.out.println("▷  현재시각 2 => " + sdformat.format(now));
	      // ▷  현재시각 2 => 2021-12-20 15:04:26
	      //간단하게 년월시분초 구할땐 date가 훨 편함.
	   ...
	   */
	   ...
	   System.out.println("이 달의 몇 째 주: " + currentDate.get(Calendar.WEEK_OF_MONTH)); //4
	    ...
	    System.out.println("시간(0~11): " + currentDate.get(Calendar.HOUR));//3
	    System.out.println("시간(0~23): " + currentDate.get(Calendar.HOUR_OF_DAY)); //15

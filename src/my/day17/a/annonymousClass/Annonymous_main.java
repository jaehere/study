...
*/
						        //원래는 new 뒤에 클래스명을 넣으나 인터페이스를 넣어주는 것은 정의와 동시에 객체를 하나 ㅁ만들어준다
									//클래스를 만들면서 동시에 하나를 인터페이스화 시키는 것임
		...
		double areaSize4 = areaObj.area(20.5, 15.5);
		System.out.println(areaSize4);

...
public class ArrayMain {
	...
	// === 메소드 파라미터 가변인수 사용하기 ===
	public int hapgae(int ... point) {  //배열은 아닌데 마치 배열처럼 쓰임
...
//1. == 배열의 선언 ==
		int[] subjectArr;  //주사용// 선언만 해두었찌 메모리에는 안올라감. new해야 올라간다.
	//또는
//		int subjectArr[];
...
// 3. == 선언되어진 배열에 값을 넣어주기 ==
		...
		for(int i=0;i<subjectArr.length;i++) {
			...
			sum += subjectArr[i];//배열의 인덱스 값들을 누적
			
		}//end of for---------------------------
		System.out.println("총점 : "+ sum);
		//총점 : 643
		
		double avg = Math.round((double)sum/subjectArr.length*10)/10.0;  //소수점 첫째짜리까지 반올림
	 ...
	 */
		//int[] subjectArr2; subjectArr2 = new int[7];
	...
	// 3. == 선언되어진 배열에 값을 넣어주기 ==
		...
		for(int i=0;i<subjectArr2.length;i++) {
			...
			sum += subjectArr2[i];//배열의 인덱스 값들을 누적
			
		}//end of for---------------------------
		System.out.println("총점 : "+ sum);
		//총점 : 643

		avg = Math.round((double)sum/subjectArr2.length*10)/10.0;  //소수점 첫째짜리까지 반올림
		System.out.println("평균 : "+ avg);  
		//평균 : 91.9
	 ...
	 */
		...
		for(int i=0;i<subjectArr3.length;i++) {
			...
			sum += subjectArr3[i];//배열의 인덱스 값들을 누적
			
		}//end of for---------------------------
		System.out.println("총점 : "+ sum);
		//총점 : 643

		avg = Math.round((double)sum/subjectArr3.length*10)/10.0;  //소수점 첫째짜리까지 반올림
		System.out.println("평균 : "+ avg);  
		//평균 : 91.9
	 ...
	 */
		...
		avg = Math.round((double)sum/subjectArr4.length*10)/10.0;  //소수점 첫째짜리까지 반올림
		System.out.println("평균 : "+ avg);  
		//평균 : 91.9
		...
		for(int subj : subjectArr4) {// 100,90,95,70,98,100,90
			...
			// 반복하면서 배열방에 들어있던 값을 차례차례 int subj 변수 속에 넣어준다.
		...
		ArrayMain am1 = new ArrayMain(); //인스턴스 만들기

...
public class CastingMain {
	...
	// 위의 것은 short sh = (short)no1;
		...
		int in = sh;   //int => 4byte  -21억 ~ 21억 // 대략 +- 21억
	// 위의 것은 int in = (int)sh;
		...
		float ft = 1.234f;
		System.out.println("ft => " + ft); //float 단정밀도 소숫점이하 7자리까지 표현됨.
		//ft => 1.234
		...
		//sh2=> -15536 엉뚱한 값이 나온다.  short의 범위는 플마 삼만

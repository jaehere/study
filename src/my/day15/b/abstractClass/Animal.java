...
private                                   O                    X                         X                 X
*/
//abstract public class Animal { //미완성 클래스(==추상 클래스, abstract class)        //Animal은 눈에 안보이지만 extends Object가 숨겨져있음
//또는
...
//	abstract public void move(); //미완성 메소드(==추상 메소드, abstract method)     //무조건 재정의 해야할 때 ; 를 찍음.
	//또는					//객체지향 상추캡다의 추상이랑은 다름

...
//필드는 private막아주고  메소드로 열어준는거임 if
...
public class Gujikja extends Member { // 자식클래스  //부모에서 구현으 안해두었던 인터페이스의 미완성메소드를 반드시 구현해야한다.
...
//	static int count; // Gujikja 객체(인스턴스)의 개수를 알아오려는 용도 
	...
	@Override
	public void showInfo() { // protected : 다른패키지에 있떠라도 자식클래스에서 쓸수있음
		//일반적으로 public을 줌
